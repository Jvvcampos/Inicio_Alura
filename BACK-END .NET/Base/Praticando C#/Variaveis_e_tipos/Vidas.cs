...
namespace Variaveis_e_tipos
{
    internal class Vidas
    {
        ...
        {
            /*
             Você está desenvolvendo um sistema de controle de vidas para um jogo. Nesse jogo, o jogador começa com um número inicial de vidas e,
             a cada erro, perde uma vida. Por outro lado, ao acertar, ele ganha uma vida.
            ...
            Console.WriteLine($"Vidas finais: {vidas}");
        }
    }
}
